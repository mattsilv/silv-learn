...
const MicrolearningPlatform: React.FC<MicrolearningPlatformProps> = ({
    ...
    if (quizCompleted) {
      ...
      return (
        <div className="bg-white p-6 rounded-xl shadow-sm">
          ...
          >
            Score: {scorePercentage}% ({correctAnswers}/{totalQuestions})
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start">
                    <div
                      className={`flex-shrink-0 w-5 h-5 mr-2 mt-0.5 rounded-full border ${
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Head>
        <title>{lesson.title} | MicroLearn</title>
      </Head>
      ...
      <header className="mb-8">
        ...
        <div className="flex mt-4">
          <div className="relative">
            ...
            {showStyleMenu && (
              <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg border border-gray-200 w-48 z-10">
                <div className="p-2">
                  <button
